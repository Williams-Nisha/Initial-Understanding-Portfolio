        ...
        <div class="container">
            ...
            <main>
                ...
                <article>
                    ...
                    <h3>Kids Portal</h3>
                    <p>Finished Chores</p>
                    <select name="Chore" id="finishedChore">
                        <option value="Sweep Floor">Sweep Floor</option>
                        <option value="Clean Room">Clean Room</option>
                        <option value="Vacuum">Vacuum</option>
                        <option value="Dishes">Dishes</option>
                    </select>
                    <input value="Get Time" type="button" onclick='JavaScript:setInterval("showCurrentTime()", 1000);
                            getSelectedText();' name="GetTime">
                    <script>
                        ...
                        function getSelectedText() {
                            var x = document.getElementById("finishedChore").selectedIndex;
                            var sel= document.getElementsByTagName("option")[x].value;
                            document.getElementById("result1").innerHTML = sel;
                        }
                ...
                <article>
                    ...
                    <ul>
                        ...
                        <li><a href="http://www.w3schools.com/jsref/prop_option_value.asp"> target="_blank">Pulling Values from Selected Options</a></li>
                        <li><a href="http://www.formget.com/how-to-dynamically-add-and-remove-form-fields-using-javascript/" target="_blank">Dynamically moving and removing fields</a></li>
                    </ul>
                </article>
            </main>
            <footer>
